...
from utils.GGL.inversefed.nn import MetaMonkey
        ...
        try:
            ...
            for iteration in bar:
                ...
                with torch.no_grad():
                    ...
                    bar.set_postfix(loss=f"{rec_loss.item():2.6f}")

                    # if (iteration + 1 == max_iterations) or iteration % 500 == 0:
                    #     print(f'{datetime.datetime.now().strftime("%Y%m%d-%H%M%S")} It: {iteration}. Rec. loss: {rec_loss.item():2.4f}.')
