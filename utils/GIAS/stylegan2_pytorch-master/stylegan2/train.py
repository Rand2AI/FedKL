...
class Trainer:
    ...
    def save_checkpoint(self, dir_path):
        ...
        if self.Gs is not None:
            models.save(self.Gs, os.path.join(dir_path, 'imagenet.pth'))
    ...
    def load_checkpoint(cls, checkpoint_path, dataset, **kwargs):
        ...
        if os.path.exists(os.path.join(checkpoint_path, 'imagenet.pth')):
            loaded_kwargs['Gs'] = models.load(
                os.path.join(checkpoint_path, 'imagenet.pth'),
