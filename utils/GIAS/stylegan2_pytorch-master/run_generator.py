...
_examples = """examples:
  ...
  python run_convert_from_tf --download ffhq-config-f --output G.pth D.pth imagenet.pth

  # Generate ffhq uncurated images (matches paper Figure 12)
  python %(prog)s generate_images --network=imagenet.pth --seeds=6600-6625 --truncation_psi=0.5

  # Generate ffhq curated images (matches paper Figure 11)
  python %(prog)s generate_images --network=imagenet.pth --seeds=66,230,389,1518 --truncation_psi=1.0
  ...
  python %(prog)s style_mixing_example --network=imagenet.pth --row_seeds=85,100,75,458,1500 --col_seeds=55,821,1789,293 --truncation_psi=1.0
"""
