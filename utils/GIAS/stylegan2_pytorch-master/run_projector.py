...
_examples = """examples:
  ...
  python %(prog)s project_generated_images --network=imagenet.pth --seeds=0,1,5

  # Project real images
  python %(prog)s project_real_images --network=imagenet.pth --data-dir=path/to/image_folder
